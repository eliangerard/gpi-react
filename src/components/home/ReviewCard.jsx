      ...
      <div className="wideCard">
        ...
        <div className="details-container2">
          ...
          <div className="rating2">
            ...
            <span className="star2">&#9733;</span>
            <span className="star2">&#9733;</span>
            <span className="starnonr2">&#9733;</span>
          </div>
        </div>
      </div>
      <div className="description2">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed aliquet odio sed est ultricies, ac viverra nibh laoreet.
      </div>
      <div className="wideCard">
