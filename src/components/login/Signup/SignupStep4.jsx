...
export const SignupStep4 = ({ nextStep, backStep, setLogin, setShowLanding }) => {
        ...
        <>
            <div id="signData">
                ...
                <div id="inputCode">
                    ...
                    <button className='loginButton' onClick={nextStep} id="MFA">
            ...
            <div id="signOptions">
                <div className="flex-container">
                    <button className="loginButton secondary" onClick={backStep}>
                    ...
                    <button className='loginButton' onClick={() => setShowLanding(false)}>Omitir</button>
                </div>
