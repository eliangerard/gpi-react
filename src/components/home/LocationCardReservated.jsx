...
import { FormularioModificar } from '../panel/FormularioModificar';
...
export const LocationCardReservated = ({ id, nombre, costo, ruta, ubicacion, tiempo, enFavoritos }) => {
	...
	return (
		<>
			{show && (<FormularioModificar id={id} closePop={closePopUp} />)}
...
export default LocationCardReservated;
